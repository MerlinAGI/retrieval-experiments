# Source: https://github.com/jackaduma/Vicuna-LoRA-RLHF-PyTorch/blob/main/supervised_finetune.py
...
parser.add_argument("--data_path", type=str, default="data/datasets/merge.jsonl")
parser.add_argument("--output_path", type=str, default="adapter_weights/finetuned")
parser.add_argument("--model_path", type=str,
                    default="weights/vicuna-7b")
